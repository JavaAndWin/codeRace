...
class Turn:
    ...
    robots: tuple[Robot, ...]
    team_id: str
    team_type: str  # 'challenger' or 'defender'
    ...
    def blocked(self, moving: Unit, *, ignore_robots: bool = False) -> frozenset[Pos]:
    ...
    def is_weapon_site(self, pos: Pos) -> bool:
        # Without explicit blue-zone data, treat land around the station as candidate.
